...
def make_dataloader(cfg, dataset=None, mode='train', distributed=False, num_replicas=None, rank=None,
    ...
    if mode == 'train':
        ...
        offset_file = cfg.DATASET.TRAIN_OFFSET_FILE
        ...
        offset_file = cfg.DATASET.VAL_OFFSET_FILE
        ...
        offset_file = cfg.DATASET.TEST_OFFSET_FILE
    ...
    if dataset is None:
        ...
        dataset = build_dataset(dataset_name=cfg.DATASET.DATASET, ann_file=ann_file,offset_file=offset_file, image_set=image_set,
