...
class COCOCaptionsDataset(Dataset):
    def __init__(self, ann_file,offset_file, image_set, root_path, data_path, seq_len=64,
    ...
    def data_names(self):
        return ['image', 'boxes', 'im_info', 'text',
                'relationship_label', 'mlm_labels', 'mvrc_ops', 'mvrc_labels','boxes_cls_scores']
    ...
    def __getitem__(self, index):
        ...
        boxes_cls_scores = boxes.new_zeros((boxes.shape[0], 92))
        ...
        return image, boxes, im_info, text, relationship_label, mlm_labels, mvrc_ops, mvrc_labels, boxes_cls_scores
